INSERT INTO vehicle (model, manufacturer, manufacturer_year, license_plate, engine_size, current_mileage, price_per_day, image) VALUES
...
-- INSERT INTO app_user (username, password, roles, balance) VALUES
--      ('vasile', '$2a$10$9Dlyqhacii9kXIjfWAGKC.tuKdBfV7hIw8XfIZWDwGuAc0/PCVMwy', 'USER', 123.33),
--      ( 'admin', '$2a$10$4Vez/W1VBeYiBfGIWb8EDui99mM28HWjkRUmhJTzzLiPP1yR6RNfW', 'ADMIN', -1),
--      ('user2','$2a$12$sk.bk/m7l67dE6VKvPPW8OKdJIPW0kpxFaHWhiJcdflYdzntftxI2','USER', 233.2),
--      ('user', '$2a$10$XBpYEFx/6MwynJfACpR4VOKlXJBXcVSM.owmgWsUilaJvG7dTjvIy', 'USER', 4023.21);
...
INSERT INTO app_user (username, email, password, roles, balance, customer_id) VALUES
     ...
     ('user', 'user@example.com', '$2a$10$XBpYEFx/6MwynJfACpR4VOKlXJBXcVSM.owmgWsUilaJvG7dTjvIy', 'USER', 40023.21, 23);
...
SELECT 
    ...
    DATEADD('DAY', days_count, start_date),

    days_count * (FLOOR(RAND() * 80) + 20)
FROM (
    SELECT
        DATEADD('DAY',
            FLOOR(RAND() * DATEDIFF('DAY', DATE '2020-01-01', DATE '2026-12-31')),
            DATE '2020-01-01'
        ) AS start_date,

        FLOOR(RAND() * 10) + 1 AS days_count
